...
public class PlayingManager : MonoBehaviour {
    ...
    for (int i = 0; i < jd["TransferGate"].Count; i++)
    {
        ...
        {//trible gate
            ...
            gate_object_A.transform.localScale = new Vector3(size,size,1);
            gate_object_B.transform.localScale = new Vector3(size,size,1);
            gate_object_C.transform.localScale = new Vector3(size,size,1);
            TransferGates.Add(gate_object_A);
            TransferGates.Add(gate_object_B);
        ...
        {//4 gate
            ...
            gate_object_B.transform.localScale = new Vector3(size,size,1);
            gate_object_C.transform.localScale = new Vector3(size,size,1);
            gate_object_D.transform.localScale = new Vector3(size,size,1);
            TransferGates.Add(gate_object_A);
            TransferGates.Add(gate_object_B);
            TransferGates.Add(gate_object_C);
    ...
    try{
        for (int i = 0; i < jd["ControlGate"].Count; i++)
        {
            ...
            control_object.transform.localScale = new Vector3(size,size,1);
